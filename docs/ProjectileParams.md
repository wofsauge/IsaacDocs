...
____
Also used in: [EntityProjectile](EntityProjectile.html)
___ 
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) FireDirectionLimit  {: .copyable aria-label='Variables' }
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) PositionOffset  {: .copyable aria-label='Variables' }
