...
[ ](#){: .abrep .tooltip .badge }
#### [RoomConfig Room](RoomConfig_Room.html) Data  {: .copyable aria-label='Variables' }
...
[ ](#){: .abrep .tooltip .badge }
#### [RoomConfig Room](RoomConfig_Room.html) OverrideData  {: .copyable aria-label='Variables' }
