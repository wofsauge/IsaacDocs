...
The Following fonts are used by the game and can be used with the [`Font()`](../abp/../abp/Font) class:

|**Font Name**|**Ingame Name/s**|**Ingame Example**|**Ingame Usage**|**Link to font**|
|--- |--- |--- |--- |--- |
|Droid Sans|droid|[Example Droid](../abp/images/tutorial_special_chars/example_droid.png)|(Not used ingame)|[Droid Sans](../abp/customData/droid-sans.zip)|
|PF Tempesta Seven (Condensed)|pftempestasevencondensed|[Example PF Tempesta Seven](../abp/images/tutorial_special_chars/example_pftempestasevencondensed.png)|HUD Elements like coin/key counters|[PF Tempesta Seven](https://www.dafont.com/pf-tempesta-seven.font)|
|Team Meat Font|teammeatfont10<br/>teammeatfont12<br/>teammeatfont16<br/>teammeatfont16bold|[Example teammeatfont10](../abp/images/tutorial_special_chars/example_teammeat10.png)<br/>[Example teammeatfont12](../abp/images/tutorial_special_chars/example_teammeat12.png)<br/>[Example teammeatfont16](../abp/images/tutorial_special_chars/example_teammeat16.png)<br/>[Example teammeatfont16bold](../abp/images/tutorial_special_chars/example_teammeat16bold.png)|Main Menu Elements<br/>Pop-Ups<br/>Timer / Score Elements|[Team Meat Font without Bold](../abp/customData/team-meat-font_1.2.zip)|
|Terminus|terminus<br/>terminus8|[Example Terminus](../abp/images/tutorial_special_chars/example_terminus.png)<br/>[Example Terminus8](../abp/images/tutorial_special_chars/example_terminus8.png)|Debug Console / Isaac.RenderText()|[Terminus](http://terminus-font.sourceforge.net/)|
|Upheaval|upheaval|[Example Upheaval](../abp/images/tutorial_special_chars/example_upheaval.png)|Streak text|[Upheaval](https://www.dafont.com/upheaval.font)|
|mplus (Japanese)|mplus_10r<br/>mplus_12b|[Example mplus_10r](../abp/images/tutorial_special_chars/example_mplus10r.png)<br/>[Example mplus_12b](../abp/images/tutorial_special_chars/example_mplus12b.png)|Replacement for all fonts aboth for Japanese translation.<br/>10r is pf "Tempesta seven" / "Team Meat" replacement<br/>12b is "Upheaval" replacement|[PixelMplus](http://itouhiro.hatenablog.com/entry/20130602/font)  
[(M+ Fonts)](https://mplus-fonts.osdn.jp/)|
|kr Font (Korean)|kr_font12<br/>kr_font14|[Example kr_font12](../abp/images/tutorial_special_chars/example_krfont12.png)<br/>[Example kr_font14](../abp/images/tutorial_special_chars/example_krfont14.png)|TBD|No source found right now|
|Team Meat Font (Korean)|kr_meatfont14|[Example kr_meatfont14](../abp/images/tutorial_special_chars/example_krmeatfont14.png)|TBD|- Not available -|
...
**Result:**  
![](../abp/images/tutorial_special_chars/b1.png)  
...
![](../abp/images/tutorial_special_chars/b2.png)  
...
![](../abp/images/tutorial_special_chars/b3.png)  
...
![](../abp/images/BM_font-settings.png){: style="float:right"}
...
![](../abp/images/BM_export-settings.png){: style="float:right"}
