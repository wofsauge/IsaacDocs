...
[ ](#){: .abrep .tooltip .badge }
#### void EvadeTarget ( [Vector](../rep/Vector) TargetPos ) {: .copyable aria-label='Functions' }

___ 
### Find·Grid·Path () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### void FindGridPath ( [Vector](../rep/Vector) Pos, float Speed, int PathMarker, boolean UseDirectPath ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### boolean HasPathToPos ( [Vector](../rep/Vector) Pos, boolean IgnorePoop ) {: .copyable aria-label='Functions' }
