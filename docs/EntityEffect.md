...
[ ](#){: .abrep .tooltip .badge }
#### void FollowParent ( [Entity](../rep/Entity) Parent ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### void SetDamageSource ( [EntityType](../rep/enums/EntityType) DamageSource ) {: .copyable aria-label='Functions' }
