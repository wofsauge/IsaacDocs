...
[ ](#){: .abp .tooltip .badge }
#### [Vector](../abp/Vector) CalcTargetPosition ( float DistanceLimit ) {: .copyable aria-label='Functions' }

___ 
### Can·Be·Damaged·From·Velocity () {: aria-label='Functions' }
[ ](#){: .abp .tooltip .badge }
#### boolean CanBeDamagedFromVelocity ( [Vector](../abp/Vector) Velocity ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abp .tooltip .badge }
#### [EntityProjectile](../abp/EntityProjectile) FireBossProjectiles ( int NumProjectiles, [Vector](../abp/Vector) TargetPos, float TrajectoryModifier, [ProjectileParams](../abp/ProjectileParams) Params ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abp .tooltip .badge }
#### void FireProjectiles ( [Vector](../abp/Vector) Pos, [Vector](../abp/Vector) Velocity, ProjectilesMode Mode, [ProjectileParams](../abp/ProjectileParams) Params ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abp .tooltip .badge }
#### [Entity](../abp/Entity) GetPlayerTarget ( ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abp .tooltip .badge }
#### [EntityEffect](../abp/EntityEffect) MakeSplat ( float Size ) {: .copyable aria-label='Functions' }

___ 
### Morph () {: aria-label='Functions' }
[ ](#){: .abp .tooltip .badge }
#### boolean Morph ( [EntityType](../abp/enums/EntityType) , int Variant, int SubType, int ChampionColorIdx ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abp .tooltip .badge }
#### void PlaySound ( [SoundEffect](../abp/enums/SoundEffect) ID, float Volume, int FrameDelay, boolean Loop, float Pitch ) {: .copyable aria-label='Functions' }

___ 
### Query·NPCs·Group () {: aria-label='Functions' }
[ ](#){: .abp .tooltip .badge }
#### [EntityList](../abp/CppContainer_EntityList) QueryNPCsGroup ( int GroupIdx ) {: .copyable aria-label='Functions' }

___ 
### Query·NPCs·Spawner·Type () {: aria-label='Functions' }
[ ](#){: .abp .tooltip .badge }
#### [EntityList](../abp/CppContainer_EntityList) QueryNPCsSpawnerType ( [EntityType](../abp/enums/EntityType) SpawnerType, [EntityType](../abp/enums/EntityType) Type, boolean OnlyEnemies ) {: .copyable aria-label='Functions' }

___ 
### Query·NPCs·Type () {: aria-label='Functions' }
[ ](#){: .abp .tooltip .badge }
#### [EntityList](../abp/CppContainer_EntityList) QueryNPCsType ( [EntityType](../abp/enums/EntityType) Type, int Variant ) {: .copyable aria-label='Functions' }
...
#### static ThrowSpider ( [Vector](../abp/Vector) Position, [Entity](../abp/Entity) Spawner, [Vector](../abp/Vector) TargetPos, boolean Big, float YOffset ) {: .copyable aria-label='Functions' }
...
#### const [EntityNPC](../abp/EntityNPC) ChildNPC  {: .copyable aria-label='Variables' data-altreturn='nil' }

___ 
### Entity·Ref {: aria-label='Variables' }
[ ](#){: .abp .tooltip .badge }
#### [Entity](../abp/Entity) EntityRef {: .copyable aria-label='Variables' }
...
[ ](#){: .const .tooltip .badge } [ ](#){: .abp .tooltip .badge }
#### const [EntityNPC](../abp/EntityNPC) ParentNPC  {: .copyable aria-label='Variables' data-altreturn='nil' }
parent entity, for multi-entity NPCs like Larry Jr. 
___ 
### Pathfinder {: aria-label='Variables' }
[ ](#){: .abp .tooltip .badge }
#### [PathFinder](../abp/PathFinder) Pathfinder  {: .copyable aria-label='Variables' }
...
[ ](#){: .abp .tooltip .badge }
#### [Vector](../abp/Vector) V1  {: .copyable aria-label='Variables' }
general usage for ai_* functions, initialized to (0,0) 
___ 
### V2 {: aria-label='Variables' }
[ ](#){: .abp .tooltip .badge }
#### [Vector](../abp/Vector) V2  {: .copyable aria-label='Variables' }
