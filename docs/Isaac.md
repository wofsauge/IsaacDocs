...
It is recommended to use the [AddCallback](ModReference.html#addcallback) function on a [Mod Reference](ModReference.html) instead.
...
[Debug Console Tutorial](tutorials.htmlDebugConsole) for informations on how to use commands.
___ 
### Explode () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### void Explode ( [Vector](Vector.html) pos, [Entity](Entity.html) source, float damage ) {: .copyable aria-label='Functions' }
...
This function therefore works drastically different than `:::lua Game():GetFrameCount()`[Link](Game.html#GetFrameCount)
___ 
### Get·Free·Near·Position () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) GetFreeNearPosition ( [Vector](Vector.html) pos, float step ) {: .copyable aria-label='Functions' }

___ 
### Get·Item·Config () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### [Config](ItemConfig.html) GetItemConfig ( ) {: .copyable aria-label='Functions' }
Returns the [ItemConfig::Config](ItemConfig.html) object.
___ 
...
[ ](#){: .rep .tooltip .badge }
#### [EntityPlayer](EntityPlayer.html) GetPlayer ( int playerId = 0 ) {: .copyable aria-label='Functions' data-altreturn='nil' }
...
This function is the same as [`Game():GetPlayer()`](Game.html#getplayer).
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) GetRandomPosition ( ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### [GridEntity](GridEntity.html) GridSpawn ( [GridEntity](GridEntity.html) gridEntityType, int Variant, [Vector](Vector.html) position, boolean forced ) {: .copyable aria-label='Functions' }

Spawn a [GridEntity](GridEntity.html) at the given position (world coordinates).
...
It is recommended to use the [HasData](ModReference.html#hasdata) function on a [Mod Reference](ModReference.html) instead.
___ 
...
It is recommended to use the [LoadData](ModReference.html#loaddata) function on a [Mod Reference](ModReference.html) instead.
___ 
...
Registers a table with the game to use as a [Mod Reference](ModReference.html).

It is recommended to use the global [RegisterMod](Functions.html#registermod) function instead.
...
It is recommended to use the [RemoveCallback](ModReference.html#removecallback) function on a [Mod Reference](ModReference.html) instead.
...
It is recommended to use the [RemoveData](ModReference.html#removedata) function on a [Mod Reference](ModReference.html) instead.
___ 
...
It is recommended to use the [SaveData](ModReference.html#savedata) function on a [Mod Reference](ModReference.html) instead.
___ 
### Screen·To·World () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) ScreenToWorld ( [Vector](Vector.html) pos ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) ScreenToWorldDistance ( [Vector](Vector.html) pos ) {: .copyable aria-label='Functions' }

___ 
### Spawn () {: aria-label='Functions' }
[ ](#){: .abrep .tooltip .badge }
#### [Entity](Entity.html) Spawn ( int entityType, int entityVariant, int entitySubtype, [Vector](Vector.html) position, [Vector](Vector.html) velocity, [Entity](Entity.html) Spawner ) {: .copyable aria-label='Functions' }

Spawns the defined entity at the given location. If the position is not free, it spawns it in the nearest free position.
There are two spawn functions. [Isaac.Spawn()](Isaac.html#spawn) and [Game():Spawn()](Game.html#spawn). If you need to spawn something with a specific seed, then you use [Game():Spawn()](Game.html#spawn). If you need to spawn something with a randomly generated seed, then use [Isaac.Spawn()](Isaac.html#spawn). Most of the time, you will probably want to use [Isaac.Spawn()](Isaac.html#spawn).
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) WorldToRenderPosition ( [Vector](Vector.html) pos ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) WorldToScreen ( [Vector](Vector.html) pos ) {: .copyable aria-label='Functions' }
...
[ ](#){: .abrep .tooltip .badge }
#### [Vector](Vector.html) WorldToScreenDistance ( [Vector](Vector.html) pos ) {: .copyable aria-label='Functions' }
