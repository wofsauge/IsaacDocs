...
| | |Ipecac|14|0|0|0|0|0|Attack2| | |ProjectileCooldown increases by 256 with every shot Resetting ProjectileCooldown to 0 can extend the attackProjectileCooldown increases by 256 with every shot Resetting ProjectileCooldown to 0 can extend the attackProjectileCooldown increases by 256 with every shot Resetting ProjectileCooldown to 0 can extend the attackProjectileCooldown increases by 256 with every shot Resetting ProjectileCooldown to 0 can extend the attack|
...
| | |Tears Rings|8|0|0|0|V1.X = Open Angle|0|Attack1*|Sound Shoot (Start)Sound Shoot (Start)Sound Shoot (Start)Sound Shoot (Start)|6 336 336 336 33| |
| | |Teleport|6|0|0|0|0|0|Teleport|Sound ShootSound ShootSound ShootSound Shoot|18 2118 2118 2118 21| |
| | | |4|0|0|0|0|0| | | | |
| | | |7|0|0|0|0|0|TeleportEnd|Sound ShootSound ShootSound Shoot|7 127 127 12| |
| | |Summon|12|0|0|0|0|0|Recall|Sound|7| |
| | | |13|0|0|0|0|0|HoverStart HoverLoopHoverStart HoverLoopHoverStart HoverLoop| | | |
| | | |5|0|0|0|0|0|Slash*| | | |
| | |Slap|11|0|0|0|0|0|Slash*|Sound ShootSound ShootSound Shoot|6 176 176 17| |
| | |Charm|10|0|0|0|0|0|Attack2*|Sound ShootSound ShootSound Shoot|6 29 (A) / 31 (B)6 29 (A) / 31 (B)6 29 (A) / 31 (B)| |
|The Visage (P1)The Visage (P1)The Visage (P1)|903.0 + 903.1903.0 + 903.1903.0 + 903.1|Idle|100|0 (Heart) Time before dash allowed (Mask)0 (Heart) Time before dash allowed (Mask)0 (Heart) Time before dash allowed (Mask)|0 (Heart) Direction (Mask)0 (Heart) Direction (Mask)0 (Heart) Direction (Mask)|0|(Heart) V1.Y = 150|0|Idle1 (Heart) Move* (Mask)Idle1 (Heart) Move* (Mask)Idle1 (Heart) Move* (Mask)| | | |
| | |Mask Dash|101 (Heart)|0|0|0|V1.Y = 150 + 20 * frames in state|0|Unwind|Wind|13|Synchronized : throw mask Heart transitions into State 100 when V1.Y == 650 Mask transitions into State 102 once charge startsSynchronized : throw mask Heart transitions into State 100 when V1.Y == 650 Mask transitions into State 102 once charge startsSynchronized : throw mask Heart transitions into State 100 when V1.Y == 650 Mask transitions into State 102 once charge starts|
| | | |101 (Mask)|0 1 (after trigger)0 1 (after trigger)0 1 (after trigger)|0|0|0|0|ChargeBegin*|Charge|13| |
| | | |102 (Heart)|0|0|0|V1.Y = 650 - 20 * frames in state 150 once V1.Y == 35V1.Y = 650 - 20 * frames in state 150 once V1.Y == 35V1.Y = 650 - 20 * frames in state 150 once V1.Y == 35|0|Rewind|Rewind|9|Rewind the mask|
| | | |102 (Mask)|1|0|0|0|0|Charge*| | |Actually charging|
| | | |103 (Mask)|1 Cooldown for Idle (once Heart starts Rewind)1 Cooldown for Idle (once Heart starts Rewind)1 Cooldown for Idle (once Heart starts Rewind)|0|0|0|0|ChargeHit*| | |Waiting to be reeled back in|
