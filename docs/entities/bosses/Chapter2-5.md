...
| | |1/2 Bomb|8|0|0|0|0|0|Attack1*|Sound/Shoot|6/17 (Left/Right) 6/17/27 (Double)6/17 (Left/Right) 6/17/27 (Double)6/17 (Left/Right) 6/17/27 (Double)|Bombs need to be spawned and added to summon list before switching to state 8|
...
|Great Gideon|907|Idle|3|Phase|If LSB = 1, summon If bit 8 == 1, spikes doneIf LSB = 1, summon If bit 8 == 1, spikes doneIf LSB = 1, summon If bit 8 == 1, spikes done|?|0|0|Idle| | | |
| | |Summons|13| | | |0|0|Summon|Sound|6| |
| | |Bullets|8| | | |0|0|Attack1|Shoot|32| |
| | |Flames|9| | | |0|0|Attack2*|Shoot|52 (Start) 8 (End)52 (Start) 8 (End)52 (Start) 8 (End)| |
| | |Aspiration|7| | | |0|0|Attack4*|Shoot|14 (Start) 11 (End)14 (Start) 11 (End)| |
| | |Spikes|10| | | |0|0|Attack3|Sound ShootSound Shoot|8/13/18/23/28/33 (Sound) 51 (Shoot)8/13/18/23/28/33 (Sound) 51 (Shoot)| |
|The Shell|19.3|Idle|4|0|0 if body 2 if head0 if body 2 if head|0 if intact 1 if broken0 if intact 1 if broken|V1.X = 2.5 if no previous segment broken V1.Y = movement angle, 0 if brokenV1.X = 2.5 if no previous segment broken V1.Y = movement angle, 0 if broken|0|*Rotate / *Idle| | | |
...
| | |Run|4|Timer before explosion May explode earlierTimer before explosion May explode earlier| | |0|0|Run*| | | |
...
| | |Super Blast|12|Time before land| | |0|0|SuperBlast*|Shoot Land / SoundShoot Land / Sound|30 9 / 2130 9 / 21| |
|Clickety Clack|889|Chase|4|0|0|ID in Clutch 0 = PossessedID in Clutch 0 = Possessed|0|0|Walk*|Footstep|9 / 20| |
...
| | |Clutch Possess|5|0|0| |Movement vector|0|Transition + Burst|Shoot|36 (Transition) 8 (Burst)36 (Transition) 8 (Burst)| |
