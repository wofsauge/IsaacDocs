...
|-|-|-|-|-|-|-|-|-|-|-|-|-|
|Monstro II|43.0|Jump|6|0|0: tears 1: flies0: tears 1: flies0: tears 1: flies0: tears 1: flies0: tears 1: flies|2|0|0|JumpUp|Jump|10|Gish (43.1) uses the same values|
...
| | |Puke|9|0|0|0|V1.X = Shoot Angle|0|Puking|Shoot StopShootingShoot StopShootingShoot StopShootingShoot StopShootingShoot StopShooting|10 3210 3210 3210 3210 32| |
...
| | |Tears|9|0 / 30|0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting|0|0|0|Charging + Shooting|Shoot (Shooting)|4|Kind is random|
| | |Brimstone|8|0 / 30|0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting0 = Charging 1 = Shooting|0|0|0|Charging + Shooting|Shoot (Shooting)|4| |
| | |Idle|3|0|0|0|0|0|Idle| | | |
|Loki|69|Summon|8|0|0|0|0|0|Attack02|Shoot|21|I1 = 1 / 2 if Lokii (69.1) I1 identifies each individual LokiI1 = 1 / 2 if Lokii (69.1) I1 identifies each individual LokiI1 = 1 / 2 if Lokii (69.1) I1 identifies each individual LokiI1 = 1 / 2 if Lokii (69.1) I1 identifies each individual LokiI1 = 1 / 2 if Lokii (69.1) I1 identifies each individual Loki|
